...
BUNDLES = [
    ...
    # ═══════ ⑤ 图片模型（2026-08-10 核实，只收新而优的）═══════
    {
        "id": "img_z_image_turbo",
        "name": "Z-Image-Turbo（通义官方 · 8 步快速出图）",
        "series": "图片模型 · 快速",
        "category": "image",
        "engine": "builtin",
        "partition": "图片",
        ...
        "min_ram_gb": 16,
        "recommended": True,
        "heat": "🔥 998K 下载 · 5100 ♥（2026-08-10）",
        "desc": "通义官方 Z-Image-Turbo：6B 参数 8 步出图，消费级显卡友好，内置引擎直接可用。适合快速出图、提示词试错。",
        "files": [
            {"repo": "Tongyi-MAI/Z-Image-Turbo", "path": "transformer/", "size_gb": 24.61, "dest": "transformer/", "is_dir": True},
            {"repo": "Tongyi-MAI/Z-Image-Turbo", "path": "text_encoder/", "size_gb": 8.05, "dest": "text_encoder/", "is_dir": True},
            {"repo": "Tongyi-MAI/Z-Image-Turbo", "path": "vae/", "size_gb": 0.17, "dest": "vae/", "is_dir": True},
            {"repo": "Tongyi-MAI/Z-Image-Turbo", "path": "tokenizer/", "size_gb": 0.01, "dest": "tokenizer/", "is_dir": True},
        ],
        "source_repos": {"hf": "Tongyi-MAI/Z-Image-Turbo", "hf_mirror": "Tongyi-MAI/Z-Image-Turbo"},
        "image_engine": "z_image",
    },
    {
        "id": "img_qwen_2512_bf16",
        "name": "Qwen-Image-2512（官方最新 · 高质量）",
        "series": "图片模型 · 旗舰",
        "category": "image",
        "engine": "builtin",
        "partition": "图片",
        ...
        "min_ram_gb": 32,
        "recommended": False,
        "heat": "🔥 72K 下载 · 924 ♥（2026-08-10）",
        "desc": "Qwen 官方最新图片模型（2025-12 版）：中文文字渲染能力强，写实质感好，支持负向提示词（CFG 4.0）。建议 24GB+ 显存。",
        "files": [
            {"repo": "Qwen/Qwen-Image-2512", "path": "transformer/", "size_gb": 40.94, "dest": "transformer/", "is_dir": True},
            {"repo": "Qwen/Qwen-Image-2512", "path": "text_encoder/", "size_gb": 16.58, "dest": "text_encoder/", "is_dir": True},
            {"repo": "Qwen/Qwen-Image-2512", "path": "vae/", "size_gb": 0.25, "dest": "vae/", "is_dir": True},
            {"repo": "Qwen/Qwen-Image-2512", "path": "tokenizer/", "size_gb": 0.01, "dest": "tokenizer/", "is_dir": True},
        ],
        "source_repos": {"hf": "Qwen/Qwen-Image-2512", "hf_mirror": "Qwen/Qwen-Image-2512"},
        "image_engine": "qwen_image",
    },
    {
        "id": "img_qwen_2512_gguf_q4",
        "name": "Qwen-Image-2512 GGUF Q4_K_M（低显存）",
        "series": "图片模型 · 量化",
        "category": "image",
        "engine": "comfyui",
        "partition": "图片",
        ...
        "min_ram_gb": 32,
        "recommended": False,
        "heat": "🔥 206K 下载 · 562 ♥（2026-08-10）",
        "desc": "unsloth 出品的 Qwen-Image-2512 Q4_K_M 量化（13.2GB），配合 ComfyUI-GGUF 插件使用，低显存也能跑高质量图。",
        "files": [
            {"repo": "unsloth/Qwen-Image-2512-GGUF", "path": "qwen-image-2512-Q4_K_M.gguf", "size_gb": 13.24, "dest": "qwen-image-2512-Q4_K_M.gguf"},
        ],
        "source_repos": {"hf": "unsloth/Qwen-Image-2512-GGUF", "hf_mirror": "unsloth/Qwen-Image-2512-GGUF"},
    },
    ...
    },
    {
        ...
        "name": "Qwen-Image Lightning 4 步加速 LoRA",
        "series": "社区微调 · 加速",
        "category": "lora",
        "engine": "lora",
        "partition": "图片",
        ...
        "min_ram_gb": 0,
        "recommended": False,
        "heat": "🔥 405K 下载 · 820 ♥（2026-08-10）",
        "desc": "lightx2v 的 Qwen-Image Lightning 4 步加速 LoRA（V2.0 bf16），把 Qwen-Image 采样压到 4 步。配合 Qwen-Image-2512 使用。",
        "files": [
            {"repo": "lightx2v/Qwen-Image-Lightning", "path": "Qwen-Image-Lightning-4steps-V2.0-bf16.safetensors", "size_gb": 0.85, "dest": "Qwen-Image-Lightning-4steps-V2.0-bf16.safetensors"},
        ],
        "source_repos": {"hf": "lightx2v/Qwen-Image-Lightning", "hf_mirror": "lightx2v/Qwen-Image-Lightning"},
    },
    {
