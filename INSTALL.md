...
1. 到 [Releases](https://github.com/Bullobis/kevrai-omni/releases) 下载 `Kevrai-Omni-3.0.0-x64.exe`
...
| 形态 | 文件 | 使用方式 |
|---|---|---|
| AppImage | `Kevrai-Omni-3.0.0-x86_64.AppImage` | `chmod +x` 后双击或命令行运行 |
| deb | `kevrai-omni_3.0.0_amd64.deb` | `sudo apt install ./kevrai-omni_3.0.0_amd64.deb` |

deb 安装会写入桌面项与开始菜单项；AppImage 无需安装。

## macOS

下载 `Kevrai-Omni-3.0.0.dmg`（x64 / arm64 两版），拖入 Applications。
