...
1. 到 [Releases](https://github.com/Bullobis/kevrai-omni/releases) 下载 `Kevrai-Omni-2.9.0-x64.exe`
...
下载 `Kevrai-Omni-2.9.0-x64.dmg` 或 `Kevrai-Omni-2.9.0-arm64.dmg`，拖入 Applications。
